...
bipredict = function (EDGE_LIST,chemical_border = 4,protein_border = 2,CORES=1,Exclude_outliers=F){
  my_bicliques = calculate_bicliques(CORES,EDGE_LIST,chemical_border,protein_border,Exclude_outliers)
